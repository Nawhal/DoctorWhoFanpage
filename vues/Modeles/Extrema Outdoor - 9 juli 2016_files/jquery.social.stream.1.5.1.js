		...
		create: function(el, options) {
			...
			if(this.o.filter == true || this.o.controls == true){
				...
				if(this.o.filter == true){
					...
					x += this.o.wall == true ? '<li><a href="#filter" data-group="dc-filter"  data-filter="*" class="selected link-all"><span class="filtericon all"></span></a></li>' : '' ;
					x += '<li> <a href="#filter" rel="facebook" data-group="dc-filter" data-filter=".dcsns-facebook" class="custom-link-facebook"><span class="filtericon facebook"></span></a> </li>';
					x += '<li> <a href="#filter" rel="twitter" data-group="dc-filter" data-filter=".dcsns-twitter" class="custom-link-twitter"><span class="filtericon twitter"></span></a> </li>';
					x += '<li> <a href="#filter" rel="instagram" data-group="dc-filter" data-filter=".dcsns-instagram, .dcsns-pinterest" class="custom-link-photos"><span class="filtericon instagram"></span></a> </li>';
/* 					x += '<li> <a href="#filter" rel="video" data-group="dc-filter" data-filter=".dcsns-youtube, .dcsns-vimeo" class="custom-link-video">VIDEO</a> </li>'; */;
					x += '</ul>';
				}
					...
					$.each(a, function(i,item){
						if(i < n){
							...
							switch(type)
							{
								...
								if( item.caption.text.indexOf( "daretobe" ) !== -1 ) { 
									y += "<span class='this_daretobe'> </span>";
								}
								else if( item.caption.text.indexOf( "DareToBe" ) !== -1 ) { 
									y += "<span class='this_daretobe'> </span>";
								}
							...
							$.each(o.out.split(','), function(i,v){
								...
								switch(v)
								{
									case 'intro':
									if(type == 'twitter'){
										zintro = '<span class="section-'+v+'"><a href="'+q+'">'+type+'</a> <span><a href="https://twitter.com/'+un+'/status/'+item.id_str+'">'+nicetime(new Date(d).getTime(),0)+'</a></span></span>';
									} else {
										zintro = '<span class="section-'+v+'"><a href="'+q+'">'+type+'</a> <span>'+nicetime(new Date(d).getTime(),0)+'</span></span>';
									}
									break;
									case 'title':
									zz += x;
